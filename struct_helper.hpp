...
inline void request_init(Request* r, std::string method_in, std::string host_in, std::string port_in, std::vector<char> fullmsg_in, std::string line_in, std::string url_in) {
    r->method = method_in;
    r->host = host_in;
    r->port = port_in;
